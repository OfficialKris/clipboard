...
var (
	...
	_NSPasteboardTypeString = must(purego.Dlsym(purego.RTLD_DEFAULT, "NSPasteboardTypeString"))
	_NSPasteboardTypePNG    = must(purego.Dlsym(purego.RTLD_DEFAULT, "NSPasteboardTypePNG"))
)
